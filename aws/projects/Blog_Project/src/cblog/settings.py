...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cy12wywsusbs.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'emreblog' # please enter your s3 bucket name
